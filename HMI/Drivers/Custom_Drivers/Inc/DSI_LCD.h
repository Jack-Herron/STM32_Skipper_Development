...
#define DSI_LCD___PATTERN_ORIENTATION_LANDSCAPE	1	// horizontal bars
#define DSI_LCD___PATTERN_ORIENTATION_PORTRAIT	0	// vertical bars
...
#define DSI_LCD___BYTES_PER_PIXEL			0x02
// Functions
