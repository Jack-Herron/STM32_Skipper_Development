...
///////////////////// VARIABLES ////////////////////
lv_anim_t * DuckAnim_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * DuckAnim_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_1, -60, 60);
    lv_anim_set_path_cb(&PropertyAnimation_1, lv_anim_path_linear);
    lv_anim_set_delay(&PropertyAnimation_1, delay + 1300);
    lv_anim_set_deleted_cb(&PropertyAnimation_1, _ui_anim_callback_free_user_data);
    lv_anim_set_playback_time(&PropertyAnimation_1, 0);
    lv_anim_set_playback_delay(&PropertyAnimation_1, 0);
    lv_anim_set_repeat_count(&PropertyAnimation_1, LV_ANIM_REPEAT_INFINITE);
    lv_anim_set_repeat_delay(&PropertyAnimation_1, 2000);
    ...
    lv_anim_set_values(&PropertyAnimation_2, 60, -60);
    ...
    lv_anim_set_repeat_delay(&PropertyAnimation_2, 2000);
