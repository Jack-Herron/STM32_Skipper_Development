...
#define USB_LL_Definitions___MAX_NUMBER_OF_CHANNELS_PER_PORT		USB_LL_Definitions___get_Max(USB_OTG_HS_HOST_MAX_CHANNEL_NBR, USB_OTG_FS_HOST_MAX_CHANNEL_NBR)
