...
#define USB_Host_Config___DYNAMICALLY_ALLOCATE_USB_HUBS                 true		// highly recommended to leave this option false
#define USB_Host_Config___MAX_USB_HUBS                                  0x01

#define USB_Host_Config___GET_STRINGS                                   false
