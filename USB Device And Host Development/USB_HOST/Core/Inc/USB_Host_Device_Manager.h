...
#define USB_Host_Device_Manager___STANDARD_NUMBER_OF_RETRIES						0xff
...
typedef struct USB_Host_Device_Manager___Polling_Device_Node{
	...
	void 																(*callback)			(uint8_t port_Number , void* context);
	void*																context;
...
typedef struct {
	...
	void																(*device_Set_Configuration_Callback)																														(uint8_t port_Number , uint8_t device_Address, uint8_t configuration_Number);
...
struct USB_Host_Device_Manager___Device_TypeDef{
	...
	USB_Host_Device_Manager___Polling_Device_Node_TypeDef				device_Polling_Process;
	USB_Host_Device_Manager___Polling_Device_Node_TypeDef				interface_Polling_Process[USB_Host_Config___DEVICE_MAX_NUMBER_OF_CONFIGURATIONS][USB_Host_Config___DEVICE_MAX_NUMBER_OF_INTERFACE_DESCRIPTORS];
};
...
void 											USB_Host_Device_Manager___Set_Device_Current_Configuration						(uint8_t port_Number, uint8_t device_Address, uint8_t configuration_Index);
