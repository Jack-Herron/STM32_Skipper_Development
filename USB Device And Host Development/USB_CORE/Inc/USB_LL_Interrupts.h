...
#define USB_LL_Interrupts___HOST_PORT_INTERRUPTS_MASK				0x000a
...
#define USB_LL_Interrupts___CHANNEL_INTERRUPTS_MASK					0x029b
#define USB_LL_Interrupts___HPRT_RC_W1_BITS							0x2e
typedef enum {
