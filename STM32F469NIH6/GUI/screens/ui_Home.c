...
lv_obj_t * ui_Driving_column1 = NULL;
...
lv_obj_t * ui_Space4 = NULL;
lv_obj_t * ui_Group_Arrival = NULL;
lv_obj_t * ui_Label_Arrival_Time_Number1 = NULL;
lv_obj_t * ui_Label_arrival = NULL;
...
lv_obj_t * ui_Group_battery_info = NULL;
...
void ui_Home_screen_init(void)
{
    ...
    ui_Spinner2 = lv_spinner_create(ui_Home);
    //lv_spinner_set_anim_params(ui_Spinner2, 1000, 90);
    lv_obj_set_width(ui_Spinner2, 305);
    lv_obj_set_height(ui_Spinner2, 317);
